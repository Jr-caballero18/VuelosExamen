...
public class VuelosControler {
    ...
    try {
        ...
        Vuelos v = new Vuelos(model.getCodigo(), model.getOrigen(), model.getDestino(),model.getHora(), model.getFecha_llegada(),model.getFecha_completa(), model.getNumeroPasajeros());
        listadv.add(v);
